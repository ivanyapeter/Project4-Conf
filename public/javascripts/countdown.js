// Display countdown timer for the event
$(document).ready(function() {
  ...
  var displayRemaining = function() { // calculate and display remaining time
    ...
    if (remainingTime < 0) {
      ...
      // post the remaining time to the DOM
  ...
  setInterval(displayRemaining, 1000); // call function and update each second
});
